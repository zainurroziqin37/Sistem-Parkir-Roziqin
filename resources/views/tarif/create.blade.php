...
<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <h2 class="mt-1 text-3xl font-bold text-white">Tambah Tarif Baru</h2>
        </div>
    ...
    <div class="rounded-2xl border border-blue-500/20 bg-[#071426] p-6 shadow-2xl shadow-blue-950/40">
        <form action="{{ route('admin.tarif.store') }}" method="POST" class="space-y-5">
            @csrf

            <!-- Input Jenis Kendaraan -->
            <div>
                <label for="jenis_kendaraan" class="block text-sm font-medium text-slate-300 mb-2">Jenis Kendaraan</label>
                <input type="text" name="jenis_kendaraan" id="jenis_kendaraan" value="{{ old('jenis_kendaraan') }}" placeholder="Contoh: Mobil, Motor, Truk" required
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="tarif_per_jam" id="tarif_per_jam" value="{{ old('tarif_per_jam') }}" placeholder="2000" required min="0"
